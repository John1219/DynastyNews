...
1. **Extract the ZIP Archive**:
   - Copy or download `FantasyAssistant_v1.4.zip` to any folder on your Windows PC (e.g., `Desktop` or `C:\FantasyAssistant`).
   - Right-click `FantasyAssistant_v1.4.zip` and select **Extract All...**.

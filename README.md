...
1. **Extract the ZIP Archive**:
   - Copy or download `FantasyAssistant_v1.3.zip` to any folder on your Windows PC (e.g., `Desktop` or `C:\FantasyAssistant`).
   - Right-click `FantasyAssistant_v1.3.zip` and select **Extract All...**.
